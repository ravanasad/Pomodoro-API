...
public sealed record class UserTaskDto(int Id, string Title, string Description, string Label, DateTime DueDate, TaskPriority TaskPriority, bool IsCompleted, List<UserTaskDto> extendTasks);
